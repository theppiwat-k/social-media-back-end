...
const {
    ...
    getNewFriendRequestController,
} = require('../controllers/friends/friendRequest');
const {
    accecptFriendRequestController,
} = require('../controllers/friends/accecptFriendRequest');
const {
    rejectFriendRequestController,
} = require('../controllers/friends/rejectFriendRequest');
const {
    getSuggestFriendController,
} = require('../controllers/friends/suggestFriend');
